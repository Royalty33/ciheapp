                  ...
                  children: [
                    ...
                    _buildNotificationPreferenceSwitch(
                      ...
                      (value) => _updateNotificationPreference(
                        user.notificationPreferences.copyWith(pushNotifications: value),
                      ),
                    ),
                    const Divider(),
                    _buildNotificationPreferenceSwitch(
                      'Assignment Reminders',
                      user.notificationPreferences.assignmentReminders,
                      (value) => _updateNotificationPreference(
                        user.notificationPreferences.copyWith(assignmentReminders: value),
                      ),
                    ),
                    _buildNotificationPreferenceSwitch(
                      'Exam Reminders',
                      user.notificationPreferences.examReminders,
                      (value) => _updateNotificationPreference(
                        user.notificationPreferences.copyWith(examReminders: value),
                      ),
                    ),
                    _buildNotificationPreferenceSwitch(
                      'College Notices',
                      user.notificationPreferences.collegeNotices,
                      (value) => _updateNotificationPreference(
                        user.notificationPreferences.copyWith(collegeNotices: value),
                      ),
                    ),
                  ],
                ),
